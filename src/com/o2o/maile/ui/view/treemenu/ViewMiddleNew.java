...
public class ViewMiddleNew extends LinearLayout implements ViewBaseAction {
	...
	public ViewMiddleNew(Context context) {
		super(context);
		init(context);
	}

	public ViewMiddleNew(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
